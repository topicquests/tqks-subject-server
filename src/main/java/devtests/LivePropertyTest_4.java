 ...
 *
 */
public class LivePropertyTest_4 {
  ...
  public LivePropertyTest_4() {
    ...
    p.addPropertyValue(KEY, VALUE3);
    System.out.println("CCC "+p.getProperty(KEY));
    p.removePropertyValue(KEY, VALUE1);
    System.out.println("DDD "+p.getProperty(KEY));
    p.removeProperty(KEY);
    System.out.println("EEE "+p.getProperty(KEY));
    ...
    System.out.println("Finished LivePropertyTest_4\n-------------------\n");
  }
  //STARTING e3ad096d-5ec5-4639-b384-71c81716c5ea
  //	AAA  null
  //	BBB [AnotherThing, SomethingElse]
  //	CCC [WhyNot?, AnotherThing, SomethingElse]
  //	DDD [WhyNot?, AnotherThing]
  //	EEE null
